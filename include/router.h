...
template <unsigned int N_TARGETS> struct Router : sc_module {
    ...
    SC_CTOR(Router) : target_socket("target_socket") {
        ...
        for (unsigned int i = 0; i < N_TARGETS; i++) {
            ...
            // *********************************************
            // Register callbacks for incoming interface method calls, including
            // tags
            // *********************************************
    ...
    virtual bool get_direct_mem_ptr(tlm::tlm_generic_payload &trans,
        ...
        bool status =
            (*initiator_socket[target_nr])->get_direct_mem_ptr(trans, dmi_data);
