...
struct Initiator : sc_module {
    ...
    void thread_process() {
        // TLM-2 generic payload transaction, reused across calls to
        // b_transport, DMI and debug
        ...
        for (int i = 256 - 64; i < 256 + 64; i += 4) {
            ...
            if (dmi_ptr_valid &&
                ...
                // Other fields default: byte enable = 0, streaming width = 0,
                // DMI_hint = false, no extensions
